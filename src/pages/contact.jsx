        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 px-16 py-8 md:p-16 bg-gray-500 rounded-xl shadow justify-center items-center shadow-lg">
                ...
                <div className="flex flex-col gap-2 md:gap-8 md:border-l border-gray-200 md:pl-6">
                    <a href='tel:01040289931' 
                        className="flex text-white text-md md:text-3xl opacity-60 hover:opacity-40 gap-2">
                        <FaPhoneAlt className="mt-1"/> +82-10-4028-9931
                    </a>
                    <a href='mailto:kimseonoh101@gmail.com' 
                        className="flex text-white text-md md:text-3xl opacity-60 hover:opacity-40 gap-2">
                        <FaEnvelope className="mt-1"/> kimseonoh101@gmail.com
                    </a>
